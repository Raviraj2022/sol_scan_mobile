...
import { SwapScreen } from './src/screens/SwapScreens';
  ...
  <SafeAreaProvider>
    <SafeAreaView style={s.safe} edges={["top", "left", "right"]}>
       <StatusBar style="light" />
        ...
        <View style={s.tabBar}>
<TouchableOpacity style={s.tab} onPress={()=>setActiveTab("wallet")}>
<Ionicons
...
<Text style={[s.tabLabel, activeTab === "wallet" && s.tabActive]}>Wallet</Text>
</TouchableOpacity>
...
<Text style={[s.tabLabel, activeTab === "swap" && s.tabActive]}>Swap</Text>
</TouchableOpacity>
        </View>
    </SafeAreaView>
    </SafeAreaProvider>
